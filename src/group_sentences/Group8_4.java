...
/**
 * Nhóm câu nói về một vài công ti trong top 20 công ti có giá trị vốn hóa thị trường cao nhất bị giảm giá.
 * @author Luong Cuong Thinh
 */
public class Group8_4 extends Group{

	{
		this.setTag("Top 20 công ti có giá trị vốn hóa thị trường cao nhất giảm giá");
	...
	public void init(Data data) {
		...
		this.myMap = (new Rule8()).applyRule(inc,"giảm");
	}
}
