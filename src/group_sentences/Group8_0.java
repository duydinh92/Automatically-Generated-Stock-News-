...
/**
 * Nhóm câu về các mã bất kì có sự giảm giá.
 * @author LƯơng Cường Thịnh
 */
public class Group8_0 extends Group{
	
	{
		this.setTag("Giảm giá");
	...
	public void init(Data data) {
		Input[] dec = data.getProcessor().top60ValueChangeDecrease();
		this.myMap = (new Rule8()).applyRule(dec,"giảm");
	}
}
